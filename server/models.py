...
class Employee(db.Model):
    ...
    # The relationship() method is passed an additional parameter secondary, which indicates the relationship is implemented through the employee_meetings table.
    ...
    '''
    The first argument indicates the relationship property we intend to use as 'connector' and the second argument indicates the name of 
    the model we're trying to connect to. The creator parameter takes a function (an anonymous lambda function in this case) which accepts 
    as argument an object of the other independent class and returns the corresponding object of the 'connecting' class that made 
